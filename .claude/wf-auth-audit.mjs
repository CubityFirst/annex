...
const CONTEXT = [
  ...
  'Base every claim on source you have read, and cite file:line for it.',
  '',
  ...
  'description. Leave out generic best-practice advice the code already follows; report actual',
  ...
  (review, d) => {
    ...
    return parallel(findings.map((f) => () =>
      agent(
        ...
        'A prior reviewer reported the finding below. Your job is to check whether it is wrong. Open the cited file(s) with Read,\n' +
